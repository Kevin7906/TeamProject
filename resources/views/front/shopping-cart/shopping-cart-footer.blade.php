<div class="cart-footer">
    <div class="d-flex flex-column  align-items-end mt-4 pt-4">
        ...
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>小計:</span><span class="subtotal_price" id="subtotal">${{number_format($total ?? \Cart::getSubTotal())}}</span>
        </div>
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>運費:</span><span class="freight_fee" id="change">$60</span>
        </div>
        <div class="w-25 d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex @if ($step == 4)justify-content-end @else justify-content-between @endif mt-4 pt-4">
        @if ($step == 1)
            <a href="{{route('donut.list')}}" class="btn px-5 backToShop_btn"><i class="fas fa-arrow-left"></i>返回購物</a>
